...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Nov 28 08:41:32 IST 2015
  */
public class Parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\126\000\002\011\003\000\002\002\004\000\002\010" +
    "\004\000\002\010\002\000\002\012\010\000\002\014\002" +
    "\000\002\014\004\000\002\007\002\000\002\007\004\000" +
    "\002\022\003\000\002\022\003\000\002\023\005\000\002" +
    "\013\003\000\002\013\005\000\002\016\011\000\002\017" +
    "\005\000\002\017\004\000\002\017\005\000\002\017\004" +
    "\000\002\015\003\000\002\015\003\000\002\015\003\000" +
    "\002\015\003\000\002\015\005\000\002\024\002\000\002" +
    "\024\003\000\002\020\004\000\002\020\006\000\002\006" +
    ...
    "\002\000\002\034\004\000\002\021\002\000\002\021\003" +
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\002\001\001\000\002\001\001\000\010\015\042\020\043" +
    "\024\044\001\001\000\002\001\001\000\002\001\001\000" +
    "\002\001\001\000\002\001\001\000\004\006\047\001\001" +
    "\000\024\002\053\003\102\005\071\015\056\025\100\026" +
    ...
    "\002\001\001\000\022\002\173\005\071\021\174\025\113" +
    ...
    "\015\151\001\001\000\002\001\001\000\002\001\001\000" +
    ...
    "\003\167\005\071\015\056\025\100\026\062\030\060\031" +
    "\050\032\074\001\001\000\004\033\170\001\001\000\002" +
    "\001\001\000\024\002\053\003\172\005\071\015\056\025" +
    ...
    "\060\031\110\032\074\001\001\000\004\004\133\001\001" +
    "\000\024\002\053\003\206\005\071\015\056\025\100\026" +
    "\062\030\060\031\050\032\074\001\001\000\002\001\001" +
    "\000\004\004\133\001\001\000\002\001\001\000\024\002" +
    "\053\003\102\005\071\015\056\025\100\026\062\030\060" +
    ...
    "\002\001\001\000\002\001\001\000\006\015\042\020\221" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "" });
...
class CUP$Parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action(
      ...
      switch (CUP$Parser$act_num)
        {
		 ...
		 RESULT = Operator.LNEG; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("unop",3, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
          ...
          case 78: // binop ::= MOD 
            {
              Operator RESULT =null;
		 RESULT = Operator.MOD; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("binop",2, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		ASTExpr e1 = (ASTExpr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
              ...
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("maby_expr",15, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		ASTNode e1 = (ASTNode)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		...
		int eright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).right;
		ASTExpr e = (ASTExpr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 /*ASTVarExpr ve = new ASTVarExpr(v); RESULT = new ASTAssignStmt(ve, e);*/
	Parser.print_rule("stmt -> 'v=e;' for v: " + v + "and e :" + e); 
		...
		ASTNode fl1 = (ASTNode)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new ASTExtend(""); //change me!!!!!!!
		Parser.print_rule("formals-> 't1 i1, fl1' for t1="+t1+" and i1="+i1+" and fl1="+fl1); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("formals",14, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-3)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		ASTNode fl1 = (ASTNode)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 Parser.print_rule("maybe_formals-> 'fl1' for fl1=" + fl1); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("maybe_formals",18, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		Parser.print_rule("stat_type_void-> 'void i1' for i1="+i1); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("stat_type_void",13, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		Parser.print_rule("stat_type_void-> 'static void i1' for i1="+i1); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("stat_type_void",13, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		ASTNode st1 = (ASTNode)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-6)).value;
		 RESULT = new ASTExtend(""); //change me!!!!!!!
		Parser.print_rule("stat_type_void-> 'st1 (maybe_formals) {stmt_list}' for st1="+st1); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("method",12, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-6)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		Parser.print_rule("id_list-> 'i1' for i1="+i1); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("id_list",9, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		Parser.print_rule("field_meth-> 'method'"); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("field_meth",16, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		Parser.print_rule("field_meth_list-> 'field_meth_list field_meth'"); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("field_meth_list",5, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		Parser.print_rule("field_meth_list-> 'field_meth'"); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("field_meth_list",5, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		Parser.print_rule("extend-> 'extends c1' for c1=" + c1); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("extend",10, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		Parser.print_rule("extend-> ''"); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("extend",10, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
